...
for dir in Classes Configuration Documentation Resources Build; do
...
for file in ext_emconf.php ext_localconf.php ext_tables.php ext_tables.sql ext_typoscript_setup.typoscript composer.json README.md LICENSE; do
...
rm -rf vendor/symfony 2>/dev/null || true
